package com.koreatravel.tabitomo.controller.admin;
...
public class AdminController {
    ...
    public String updateUser(@ModelAttribute MemberEntity member) {
    ...
    public String tripManagement(Model model) {
        List<TripPlan> trips = tripPlanService.findAllTripPlans();
